...
%token NAME PARENT BYTES PTR FREQ RULES EXIT DSGROUP SSPTR COMPRTN SOURCE RMNAME SEGM PUNCHEDCARD
%token STAR_EXPR NUM ID

%type<str> STAR_EXPR NUM ID SEGM PUNCHEDCARD
%type<oper> OPS TERM ARG LIST_OP OP
%type<expr> NAME PARENT BYTES PTR FREQ RULES EXIT DSGROUP SSPTR COMPRTN SOURCE RMNAME 
%type<args> ARGS
...
|	PARENT'='TERM		{ $$ = new ParserExpression("PARENT", NULL , $3 , true); }
|	BYTES'='TERM		{ $$ = new ParserExpression("BYTES", NULL , $3 , true); }
|	PTR'='TERM		{ $$ = new ParserExpression("PTR", NULL , $3 , true); }
|	FREQ'='TERM		{ $$ = new ParserExpression("FREQ", NULL , $3 , true); }
|	RULES'='TERM		{ $$ = new ParserExpression("RULES", NULL , $3 , true); }
|	EXIT'='TERM		{ $$ = new ParserExpression("EXIT", NULL , $3 , true); }
|	DSGROUP'='TERM		{ $$ = new ParserExpression("DSGROUP", NULL , $3 , true); }
|	SSPTR'='TERM		{ $$ = new ParserExpression("SSPTR", NULL , $3 , true); }
|	COMPRTN'='TERM		{ $$ = new ParserExpression("COMPRTN", NULL , $3 , true); }
|	SOURCE'='TERM		{ $$ = new ParserExpression("SOURCE", NULL , $3 , true); }
|	RMNAME'='TERM		{ $$ = new ParserExpression("RMNAME", NULL , $3 , true); }
;
