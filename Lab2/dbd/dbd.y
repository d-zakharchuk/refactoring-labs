...
%token NAME ACCESS RMNAME FRSPC PSNAME PASSWD DATXEXIT EXIT VERSION LABEL DBD PUNCHEDCARD
%token STAR_EXPR NUM ID

%type<str> STAR_EXPR NUM ID DBD PUNCHEDCARD
%type<oper> OPS TERM ARG LIST_OP OP DBD_MAIN_OP LABEL_RULE
%type<expr> NAME ACCESS RMNAME FRSPC PSNAME PASSWD DATXEXIT EXIT VERSION 
%type<args> ARGS
...
OPS:    
 DBD                        { $$ = new pr(NULL); }
| LABEL_RULE DBD_MAIN_OP    { $$ = new pr($1, $2); }
| DBD LIST_OP                     { $$ = new pr($2); }
;
...
|	ACCESS'='TERM		{ $$ = new ParserExpression("ACCESS", NULL , $3 , true); }
|	RMNAME'='TERM		{ $$ = new ParserExpression("RMNAME", NULL , $3 , true); }
|	FRSPC'='TERM		{ $$ = new ParserExpression("FRSPC", NULL , $3 , true); }
|	PSNAME'='TERM		{ $$ = new ParserExpression("PSNAME", NULL , $3 , true); }
|	PASSWD'='TERM		{ $$ = new ParserExpression("PASSWD", NULL , $3 , true); }
|	DATXEXIT'='TERM		{ $$ = new ParserExpression("DATXEXIT", NULL , $3 , true); }
|	EXIT'='TERM		{ $$ = new ParserExpression("EXIT", NULL , $3 , true); }
|	VERSION'='TERM		{ $$ = new ParserExpression("VERSION", NULL , $3 , true); }
;
