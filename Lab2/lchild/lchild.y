...
%type<str> STAR_EXPR NUM ID LCHILD PUNCHEDCARD
...
|	PAIR'='TERM		{ $$ = new ParserExpression("PAIR", NULL , $3 , true); }
|	RULES'='TERM		{ $$ = new ParserExpression("RULES", NULL , $3 , true); }
|	INDEX'='TERM		{ $$ = new ParserExpression("INDEX", NULL , $3 , true); }
|	RKSIZE'='TERM		{ $$ = new ParserExpression("RKSIZE", NULL , $3 , true); }
;
